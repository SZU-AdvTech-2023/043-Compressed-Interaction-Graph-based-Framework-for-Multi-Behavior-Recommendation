...
def parse_args():
    ...
    parser.add_argument('--decay', default=0.96, type=float, help='weight decay rate')     # loss中的𝜆 
    ...
    parser.add_argument('--data', default='JD', type=str, help='name of dataset')
    parser.add_argument('--mult', default=300, type=float, help='multiplier for the result')
    parser.add_argument('--gpu_id', default=0, type=int, help='gpu id')
    parser.add_argument('--decoder', default='sesg', type=str, help='type of decoder, selected from bilinear, shared_bottom, mmoe, ple, sesg', 'sesgpro')
    
    # parser.add_argument('--user', type=int, default=10690)    # 添加的代码
    # parser.add_argument('--item', type=int, default=13465)    # 添加的代码
